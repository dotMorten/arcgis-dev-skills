---
name: arcgis-flutter-auth-licensing
description: Help with ArcGIS Maps SDK for Flutter authentication and licensing. Use for API key setup, secure configuration, user authentication, and choosing an appropriate licensing approach for Flutter apps.
license: MIT
---

Use this skill when the task involves **credentials**, **secure configuration**, or **licensing** for an ArcGIS Maps SDK for Flutter app.
...
- Prefer secure configuration patterns already used by the app, such as:
  ...
  - existing secure storage or configuration services
...
- "Set up secure local development config for this Flutter app."
