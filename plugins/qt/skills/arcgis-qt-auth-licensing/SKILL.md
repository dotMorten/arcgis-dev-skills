---
name: arcgis-qt-auth-licensing
description: Help with ArcGIS Maps SDK for Qt authentication and licensing. Use for API key setup, secure configuration, user authentication, and choosing an appropriate licensing approach for Qt apps.
license: MIT
---

Use this skill when the task involves **credentials**, **secure configuration**, or **licensing** for an ArcGIS Maps SDK for Qt app.
...
- Prefer secure configuration patterns already used by the app, such as:
  - config files excluded from source control
  - environment-specific settings
  - existing app configuration objects
  - platform-specific secure storage where appropriate
...
- "Set up secure local development secrets for this Qt app."
