...
When symptoms involve API usage, lifecycle, toolkit controls, auth, or offline jobs, search the local sample index with `arcgis-dotnet-search` run from the plugin root:
